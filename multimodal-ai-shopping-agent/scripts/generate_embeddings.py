...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(str(Path(__file__).parent.parent / 'logs' / 'embedding_generation.log'))
    ]
)
...
def main():
    ...
    Google Best Practices (gemini-embedding-001):
    - 768 dimensions (optimal cost/quality)
    - Text-only embeddings with RETRIEVAL_DOCUMENT task type
    ...
    try:
        ...
        logger.info("1. Run: python vector_search/create_index.py")
