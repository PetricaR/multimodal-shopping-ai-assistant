...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(str(Path(__file__).parent.parent / 'logs' / 'index_creation.log'))
    ]
)
...
def main():
    ...
    - 768 dimensions (gemini-embedding-001)
    ...
    try:
        ...
        # Vertex AI expects a flat DIRECTORY uri (not a file path)
        ...
        logger.info("")
        logger.info("   python vector_search/deploy_index.py")
        logger.info("")
